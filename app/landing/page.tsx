...
export default function LandingPage() {
  ...
  const handleSearchFocus = () => {
    ...
    // Smooth scroll to position the search results in a good viewing position
    window.scrollTo({
      top: 300, // Adjust this value based on your needs
      behavior: 'smooth'
    });
  };
    ...
    <div ref={containerRef} className="bg-black min-h-screen relative overflow-hidden">
      ...
      <div className="relative mt-16  z-10 container mx-auto px-4 min-h-screen flex flex-col justify-center items-center">
        ...
        >
          ...
          {/* Updated Search Bar with scroll on focus */}
          <div className="flex justify-center mt-8 relative" ref={searchRef}>
            <div className="relative w-full max-w-2xl">
              ...
              {/* Dropdown Content */}
              {isSearchFocused && (
                <div className="absolute w-full mt-6 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden z-50">
                  <div className="p-4">
                    {searchQuery === '' ? (
                      <>
        ...
        {/* Updated Features Section without scroll-based animation */}
